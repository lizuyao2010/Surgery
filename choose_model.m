...
mdl=stepwiselm(transports,'constant','ResponseVar','survival_time','PredictorVars',{'age','age_donor','operation_year','gender','diagnosis','history_cigarette','height','weight','history_transplant','gender_donor','height_donor','weight_donor','history_cigarette_donor','history_alcohol_donor'},'CategoricalVar',{'gender','history_cigarette','history_transplant','gender_donor','history_cigarette_donor','history_alcohol_donor'})
%{
plotResiduals(mdl)
